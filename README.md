...
# Contours communaux et des carreaux de 200m : Angers et Savennières - données vectoriels 
...
Insérer image de géotraitement 
# Carte - données vectoriels 
## Descirption de la donnée 
Texte description de la donné 
# Conclusion 
Cette étude a permis de mettre en lumière les contrastes socio-économiques et territoriaux entre Angers et Savennières, deux communes du Maine-et-Loire aux profils radicalement différents. Grâce à l’analyse spatiale des contours administratifs et des carreaux de 200 mètres, nous avons pu quantifier et visualiser les dynamiques liées à l’usage du sol, à la densité de population et aux caractéristiques économiques de ces territoires.
